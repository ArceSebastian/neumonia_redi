...
class App:
    def __init__(self):
        ...
        self.button1 = ttk.Button(
            self.root, text="Predecir", state="disabled", command=bc.run_model(self)
        )
        self.button2 = ttk.Button(
            self.root, text="Cargar Imagen", command=bc.load_img_file
        )
        self.button3 = ttk.Button(self.root, text="Borrar", command=bc.delete(self))
        self.button4 = ttk.Button(self.root, text="PDF", command=bc.create_pdf(self))
